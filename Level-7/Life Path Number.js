...
// in that person's date of birth, until it is reduced to a single digit number.

// Complete the function that accepts a date of birth (as a string) in the following format: 
// "yyyy-mm-dd". The function shall return a one digit integer between 1 and 9 which represents 
// the Life Path Number of the given date of birth.

// You do not need to check that the input is correct format, you can assume that it will always 
// be a valid date (as a string) with given format.
