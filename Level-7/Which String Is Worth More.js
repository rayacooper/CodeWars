// You will be given two ASCII strings, a and b. 
...
// Hooray this one works! And isn't too long

function highestValue(a, b) {
    function innerFunc(e) {
      return e.slice().split('').reduce((acc, elem) => acc + elem.charCodeAt(0),0)
    }
  
  return innerFunc(a) < innerFunc(b) ? b : a;
}